...
namespace BEKStudio {
    public static class Constants {
        ...
        public static int START_GEM = 250;

        public static int COMPUTER_ENTRY_PRICE = 100;
        ...
        public static int IAP_PACK_1_COIN = 200;
        public static int IAP_PACK_2_COIN = 500;
        public static int IAP_PACK_3_COIN = 1100;
        public static int IAP_PACK_4_COIN = 2500;
        public static int IAP_PACK_5_COIN = 5000;
